...
When the game is ower the player is shown the modal window with the results (number of moves, total playing time and rating) and 
...
2019/03/13: JS code written by Robert Tulek (robert.tulek@gmail.com) except the shuffle function.
